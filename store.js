...
function purchaseClicked(){
    let cartValue = document.getElementsByClassName('cart-total-price')[0].innerText;
    let finalCartValue = parseFloat(cartValue.substring(1, 4));
...
function addItemToCart(title, price, imageSrc) {
    ...
    const cartRowContents = `
        <div class="cart-item cart-column">
            <img class="cart-item-img" src="${imageSrc}" width="70" height="70" />
